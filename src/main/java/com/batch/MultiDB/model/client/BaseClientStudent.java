...
@MappedSuperclass
public class BaseClientStudent implements Serializable
{
	...
	public BaseClientStudent() {
	}

	public BaseClientStudent(Integer id, Integer studentId, String studentName, Long phoneNumber, Long age,
			String location) {
		super();
		this.id = id;
		StudentId = studentId;
	...
	public static BaseClientStudent convert(Student student, BaseClientStudent clientStudent) {
